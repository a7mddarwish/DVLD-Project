...
namespace BussnisLayer
{
    public class clsTest
    {
        ...
        set
            {
                ...
                TestAppointmentInfo = clsTestAppointment.Find(value);
            }
        }
        ...
        private bool _AddNewTest()
        {
            ...
            this.TestID = AD_Tests.SaveTestWithResult(this._TestAppointmentID
               ,this.Notes,this.CreatedByUserID ,this.TestResult);
        ...
        private bool _UpdateTest()
        {
            ...
            return AD_Tests.UpdateTest(this.TestID, this.TestAppointmentID,
        ...
        public static clsTest Find(int TestID)
        {
            ...
            if (AD_Tests.GetTestInfoByID( TestID,
            ...
            (int PersonID, int LicenseClassID, clsTestType.enTestType TestTypeID)
        {
            ...
            if (AD_Tests.GetLastTestByPersonAndTestTypeAndLicenseClass
        ...
        {
            return AD_Tests.GetPassedTestCount(LocalDrivingLicenseApplicationID);
        }
